...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball gameplay and tournament preparation",
    ...
    "Drama Club": {
        "description": "Theater, acting, and creative expression",
    ...
    "Science Club": {
        "description": "Explore advanced scientific concepts and experiments",
